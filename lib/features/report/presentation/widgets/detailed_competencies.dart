...
class DetailedCompetencies extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (category == 'Mental Kepribadian') {
      ...
      double moral = recap.rawScores['moral'] ?? 0.0;
      double disiplin = recap.rawScores['disiplin'] ?? 0.0;
      double kepemimpinan = recap.rawScores['kepemimpinan'] ?? 0.0;
      double pengendalian = recap.rawScores['pengendalian_diri'] ?? 0.0;
      double penampilan = recap.rawScores['penampilan'] ?? 0.0;
      ...
      double kesStatus = 80.0 - kesPengurangan;
      double kesehatan = (kesAwal + kesAkhir + kesStatus) / 3;

      double samaptaA = 0.0;
      double pullUp = 0.0;
      double sitUp = 0.0;
      double pushUp = 0.0;
      double shuttleRun = 0.0;
      double samaptaB = 0.0;
      double jasmani = 0.0;
