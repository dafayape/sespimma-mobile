...
class _InputPrestasiScreenState extends State<InputPrestasiScreen> {
  ...
  static const Color _previewBg = Color(0xFFECFDF5);
  static const Color _previewBorder = Color(0xFFA7F3D0);
  ...
  Future<void> _loadInitialData() async {
    try {
      ...
      try {
        ...
        debugPrint('Error loading active students from backend API: $e');
        if (mounted) {
          setState(() {
            _allStudents = SerdikRealData.records;
            _isLoadingStudents = false;
  ...
  double get _accumulatedPrestasiPoint {
    double total = 0.0;
  ...
  double get _latestMentalScore {
    return _initialAverageMentalScore + _accumulatedPrestasiPoint;
  }
  ...
  Future<void> _submitData() async {
    if (_selectedStudents.isEmpty || _selectedActivities.isEmpty || _selectedPhoto == null) {
      AppNotifier.showError(context, 'Lengkapi Target Peserta Didik, Jenis Kegiatan, dan Bukti Gambar!');
      return;
    }
    ...
    try {
      ...
      try {
        await dataSource.submitPrestasiInput(
          userIds: userIds,
          itemIds: itemIds,
        ...
        // Fallback row-by-row submit if backend endpoint is unavailable
      ...
      if (mounted) {
        ...
        AppNotifier.showSuccess(
          context,
          'Data prestasi berhasil disimpan & dicatat di Audit Trail!',
        );
        Navigator.pop(context);
      }
    } catch (e) {
        ...
        if (_selectedStudents.isNotEmpty) ...[
          ...
          Wrap(
            ...
            children: _selectedStudents.map((student) {
              ...
              final photo = student['profile_photo'] ?? student['profilePhoto'];
          ...
          children: [
            RichText(
              text: TextSpan(
                ...
                children: [
                  const TextSpan(text: 'JENIS KEGIATAN '),
                  TextSpan(
                    text: '*',
                    style: TextStyle(color: Colors.red.shade600),
                  ),
        ...
        if (_selectedActivities.isNotEmpty) ...[
          ...
          Wrap(
            ...
            children: _selectedActivities.map((activity) {
              return Chip(
                label: Text(
                  '${activity.description} +${activity.point.toStringAsFixed(2)}',
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color: _selectedPhoto != null ? _emeraldGreen : Colors.blueGrey.shade200,
            ...
            child: _selectedPhoto != null
                ...
                : Column(
                    ...
                    children: [
                      ...
                      Text(
                        'PNG, JPG — bukti dokumentasi prestasi',
                        style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.w500,
                          color: Colors.blueGrey.shade400,
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Catatan tambahan dari pemberi prestasi...',
  ...
  Widget _buildMentalPreviewSection() {
    ...
    final accumulatedPrestasi = '+${_accumulatedPrestasiPoint.toStringAsFixed(2)}';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.tips_and_updates_outlined, color: Colors.green.shade800, size: 20),
          ...
          Row(
            ...
            children: [
              ...
              _buildScoreColumn('PRESTASI', accumulatedPrestasi, Colors.green.shade700),
                  ...
                  child: _isLoadingStudents
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final photo = serdik['profile_photo'] ?? serdik['profilePhoto'];
                            ...
                            return Material(
                              ...
                              child: ListTile(
                                ...
                                trailing: Icon(
                                  ...
                                  color: isSelected ? _emeraldGreen : Colors.grey.shade400,
                                ),
                                onTap: () {
                                  setState(() {
                                    if (isSelected) {
    ...
    showModalBottomSheet(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setModalState) {
          ...
          final filteredList = rewards.where((act) {
          ...
          return Container(
            ...
            child: Column(
              children: [
                _buildModalHeader('Pilih Jenis Kegiatan Prestasi', () => Navigator.pop(context)),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: TextField(
                    onChanged: (val) => setModalState(() => _activitySearchQuery = val),
                    decoration: InputDecoration(
                      hintText: 'Cari jenis kegiatan...',
                      prefixIcon: const Icon(Icons.search, color: Colors.grey),
                      filled: true,
                      fillColor: _lightGrey,
                      border: OutlineInputBorder(
                          ...
                          trailing: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  '+${act.point.toStringAsFixed(2)}',
                                  style: TextStyle(fontWeight: FontWeight.w900, color: Colors.green.shade800, fontSize: 13),
                                ),
                              ),
                              const SizedBox(width: 10),
                              Icon(
